...
class SkiresortPatchFormTest {
    ...
    class NullTest {
        ...
        @Test
        public void customerEvaluationのみがnullの時にバリデーションエラーとならないこと() {
    ...
    class EmptyStringTest {
        ...
        @Test
        public void nameとareaとcustomerEvaluationがすべて空文字の時バリデーションエラーとなること() {
    ...
    class BlankTest {
        ...
        @Test
        public void nameとareaとcustomerEvaluationがすべて半角スペースの時バリデーションエラーとなること() {
            SkiresortPatchForm skiresortPatchForm = new SkiresortPatchForm(" ", " ", " ");
    ...
    class OkPatternTest {
        ...
        @Test
        void customerEvaluation以外が空文字と半角スペースの時バリデーションエラーとならないこと() {
